...
part 'update_group_store.g.dart';

class UpdateGroupStore = _UpdateGroupStoreBase with _$UpdateGroupStore;

abstract class _UpdateGroupStoreBase with Store {
  final RegistersGroup registersGroup;

  _UpdateGroupStoreBase(this.registersGroup);
